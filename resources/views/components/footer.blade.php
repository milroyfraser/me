<footer class="py-10 md:py-16 bg-sky-100 bg-no-repeat bg-right-bottom border-b-4 border-sky-900" style="background-image: url('/img/me-transparent-bg.png')">
    <div class="container max-w-screen-xl mx-auto px-4">
        <div class="text-center">
            <h1 class="font-medium text-sky-900 text-4xl md:text-5xl mb-5">Thank you!</h1>
            ...
            <x-follow-me />
            <p class="text-gray-600 text-xs mt-20">Copyright © {{ now()->format('Y') }} Milroy Fraser.</p>
